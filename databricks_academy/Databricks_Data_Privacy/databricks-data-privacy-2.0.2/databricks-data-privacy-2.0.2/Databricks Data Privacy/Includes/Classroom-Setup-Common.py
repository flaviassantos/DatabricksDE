...
def generate_pipeline(self,
    ...
    for pipeline in self.workspace.pipelines.list_pipelines():
      if pipeline.name == pipeline_name:
        assert_false = False
        assert assert_false, f'You already have pipeline named {pipeline_name}. Please go to the Pipelines page and manually delete the pipeline. Then rerun this program to create the pipeline.'
